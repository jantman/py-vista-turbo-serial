# -*- coding: utf-8 -*-
#
# py-vista-turbo-serial documentation build configuration file, created by
...
from py_vista_turbo_serial.version import VERSION
...
project = u'py-vista-turbo-serial'
...
if is_rtd:
    ...
    htmlhelp_basename = 'py-vista-turbo-serialdoc'
...
latex_documents = [
  (master_doc, 'py-vista-turbo-serial.tex', u'py-vista-turbo-serial Documentation',
...
man_pages = [
    (master_doc, 'py-vista-turbo-serial', u'py-vista-turbo-serial Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'py-vista-turbo-serial', u'py-vista-turbo-serial Documentation',
   author, 'py-vista-turbo-serial', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/py-vista-turbo-serial'
]
